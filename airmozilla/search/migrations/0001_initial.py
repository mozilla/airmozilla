...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoggedSearch'
        db.create_table(u'search_loggedsearch', (
            ...
            ('event_clicked', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Event'], null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 26, 0, 0))),
        ))
        db.send_create_signal(u'search', ['LoggedSearch'])


    def backwards(self, orm):
        # Deleting model 'LoggedSearch'
        db.delete_table(u'search_loggedsearch')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)'}),
        ...
        u'search.loggedsearch': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)'}),
