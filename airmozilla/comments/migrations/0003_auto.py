...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Discussion', fields ['enabled']
        db.create_index(u'comments_discussion', ['enabled'])


    def backwards(self, orm):
        # Removing index on 'Discussion', fields ['enabled']
        db.delete_index(u'comments_discussion', ['enabled'])
