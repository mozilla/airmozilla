...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PopcornEdit.failed_attempts'
        db.add_column(u'popcorn_popcornedit', 'failed_attempts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PopcornEdit.failed_attempts'
        db.delete_column(u'popcorn_popcornedit', 'failed_attempts')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'popcorn.popcornedit': {
            'Meta': {'object_name': 'PopcornEdit'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']"}),
            'failed_attempts': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'upload': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['uploads.Upload']", 'null': 'True'}),
