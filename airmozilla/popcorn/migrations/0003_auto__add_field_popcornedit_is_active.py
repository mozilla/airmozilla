...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PopcornEdit.is_active'
        db.add_column(u'popcorn_popcornedit', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PopcornEdit.is_active'
        db.delete_column(u'popcorn_popcornedit', 'is_active')
