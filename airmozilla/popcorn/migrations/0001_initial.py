...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PopcornEdit'
        db.create_table(u'popcorn_popcornedit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Event'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('upload', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['uploads.Upload'], null=True)),
        ...
        db.send_create_signal(u'popcorn', ['PopcornEdit'])


    def backwards(self, orm):
        # Deleting model 'PopcornEdit'
        db.delete_table(u'popcorn_popcornedit')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
