...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AmaraVideo'
        db.create_table(u'subtitles_amaravideo', (
            ...
            ('transcript', self.gf('jsonfield.fields.JSONField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'subtitles', ['AmaraVideo'])


    def backwards(self, orm):
        # Deleting model 'AmaraVideo'
        db.delete_table(u'subtitles_amaravideo')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
        ...
        u'subtitles.amaravideo': {
            'Meta': {'object_name': 'AmaraVideo'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
