...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Survey.event'
        db.delete_column(u'surveys_survey', 'event_id')

        # Adding field 'Survey.name'
        db.add_column(u'surveys_survey', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)

        # Adding M2M table for field events on 'Survey'
        db.create_table(u'surveys_survey_events', (
        ...
        db.create_unique(u'surveys_survey_events', ['survey_id', 'event_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Survey.event'
        raise RuntimeError("Cannot reverse this migration. 'Survey.event' and its values cannot be restored.")
        # Deleting field 'Survey.name'
        db.delete_column(u'surveys_survey', 'name')

        # Removing M2M table for field events on 'Survey'
        db.delete_table('surveys_survey_events')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 28, 0, 0)'}),
        ...
        u'main.recruitmentmessage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'surveys.answer': {
            ...
            'answer': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['surveys.Question']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'surveys.question': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'question': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
        ...
        u'surveys.survey': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.Event']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
