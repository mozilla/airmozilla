...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'surveys_question', (
            ...
            ('question', self.gf('jsonfield.fields.JSONField')(default={})),
        ...
        db.create_table(u'surveys_answer', (
            ...
            ('answer', self.gf('jsonfield.fields.JSONField')(default={})),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
        ...
        u'main.recruitmentmessage': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
