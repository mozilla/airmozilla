...
urlpatterns = patterns(
    ...
    url(r'^events/(?P<id>\d+)/metadata/$',
        events.event_edit_metadata,
        name='event_edit_metadata'),
    ...
    url(r'^events/(?P<id>\d+)/reset-vidly-tag-domains/$',
        events.reset_vidly_tag_domains,
        name='reset_vidly_tag_domains'),
    ...
    url(r'^emailsending/$',
        email_sending.home,
        name='email_sending'),
    url(r'^legacy-video-migration/$',
        vidly_media.legacy_video_migration,
        name='legacy_video_migration'),
    url(r'^closed_captions/(?P<event_id>\d+)/$',
        closed_captions.event_closed_captions,
        name='event_closed_captions'),
    url(r'^closed_captions/(?P<event_id>\d+)/(?P<id>\d+)/submit/$',
        closed_captions.event_closed_captions_submit,
        name='event_closed_captions_submit'),
    url(r'^closed_captions/(?P<event_id>\d+)/(?P<id>\d+)/transcript/$',
        closed_captions.event_closed_captions_transcript,
        name='event_closed_captions_transcript'),
    ...
    url(r'^closed_captions/rev/(?P<event_id>\d+)/$',
        closed_captions.event_rev_orders,
        name='event_rev_orders'),
    url(r'^closed_captions/rev/(?P<event_id>\d+)/new/$',
        closed_captions.new_event_rev_order,
        name='new_event_rev_order'),
    url(r'^closed_captions/rev/(?P<event_id>\d+)/(?P<id>\d+)/cancel/$',
        closed_captions.event_rev_orders_cancel,
        name='event_rev_orders_cancel'),
    url(r'^closed_captions/rev/(?P<event_id>\d+)/(?P<id>\d+)/update/$',
        closed_captions.event_rev_orders_update,
        name='event_rev_orders_update'),
    url(r'^closed_captions/rev/(?P<event_id>\d+)/(?P<id>\d+)/'
        r'(?P<attachment_id>\w+)/download/$',
        closed_captions.event_rev_orders_download,
        name='event_rev_orders_download'),
