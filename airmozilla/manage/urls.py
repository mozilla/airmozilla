...
urlpatterns = patterns(
    ...
    url(r'^events/(?P<id>\d+)/survey/$', views.event_survey,
        name='event_survey'),
    url(r'^events/(?P<id>\d+)/survey/question/(?P<question_id>\d+)/$',
        views.event_survey_question_edit,
        name='event_survey_question_edit'),
    url(r'^events/(?P<id>\d+)/survey/question/(?P<question_id>\d+)/delete/$',
        views.event_survey_question_delete,
        name='event_survey_question_delete'),
    url(r'^events/(?P<id>\d+)/survey/question/new/$',
        views.event_survey_question_new,
        name='event_survey_question_new'),
