...
urlpatterns = patterns(
    ...
    url(r'^(?P<slug>[-\w]+)/edit/chapters/thumbnails$',
        edit.EventChaptersThumbnailsView.as_view(),
        name='event_chapters_thumbnails'),
    ...
    url(r'^(?P<slug>[-\w]+)/status/$',
        pages.event_status,
        name='event_status'),
    url(r'^(?P<slug>[-\w]+)/processing-timenails/$',
        pages.event_processing_timenails,
        name='event_processing_timenails'),
    url(r'^events/(?P<id>[\d]+)$',
        pages.EventByIDView.as_view(),
        name='event_by_id_redirect'),
    url(r'^edgecast.smil$',
        misc.edgecast_smil,
        name='edgecast_smil'),
)
