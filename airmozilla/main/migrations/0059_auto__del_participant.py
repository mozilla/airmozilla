...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'main_participant')


    def backwards(self, orm):
        # Adding model 'Participant'
        db.create_table(u'main_participant', (
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=65, unique=True, blank=True)),
            ('irc', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participant_creator', null=True, to=orm['auth.User'], on_delete=models.SET_NULL, blank=True)),
        ...
        db.send_create_signal(u'main', ['Participant'])
