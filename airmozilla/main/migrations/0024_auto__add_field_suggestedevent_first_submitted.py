...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedEvent.first_submitted'
        db.add_column('main_suggestedevent', 'first_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        if not db.dry_run:
            for event in orm.SuggestedEvent.objects.exclude(submitted=None):
                event.first_submitted = event.submitted
                event.save()


    def backwards(self, orm):
        # Deleting field 'SuggestedEvent.first_submitted'
        db.delete_column('main_suggestedevent', 'first_submitted')
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
        ...
        'main.eventhitstats': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
        ...
        'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
        ...
        'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
