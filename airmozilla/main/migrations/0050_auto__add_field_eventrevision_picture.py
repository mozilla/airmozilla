...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRevision.picture'
        db.add_column(u'main_eventrevision', 'picture',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_revision_picture', null=True, on_delete=models.SET_NULL, to=orm['main.Picture']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRevision.picture'
        db.delete_column(u'main_eventrevision', 'picture_id')
    ...
    models = {
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
        ...
        u'main.eventrevision': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'picture': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event_revision_picture'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['main.Picture']"}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 11, 0, 0)'}),
