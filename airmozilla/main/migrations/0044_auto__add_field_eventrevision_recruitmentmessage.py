...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRevision.recruitmentmessage'
        db.add_column(u'main_eventrevision', 'recruitmentmessage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.RecruitmentMessage'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRevision.recruitmentmessage'
        db.delete_column(u'main_eventrevision', 'recruitmentmessage_id')
