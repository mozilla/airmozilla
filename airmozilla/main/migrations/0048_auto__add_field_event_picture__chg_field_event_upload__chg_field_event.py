...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_event', 'picture',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_picture', null=True, on_delete=models.SET_NULL, to=orm['main.Picture']),
                      keep_default=False)


        # Changing field 'Event.upload'
        db.alter_column(u'main_event', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['uploads.Upload']))

        # Changing field 'Event.placeholder_img'
        db.alter_column(u'main_event', 'placeholder_img', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Event.picture'
        db.delete_column(u'main_event', 'picture_id')


        # Changing field 'Event.upload'
        db.alter_column(u'main_event', 'upload_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['uploads.Upload']))

        # User chose to not deal with backwards NULL issues for 'Event.placeholder_img'
        raise RuntimeError("Cannot reverse this migration. 'Event.placeholder_img' and its values cannot be restored.")
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
