...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_eventtweet', (
            ...
            ('send_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow)),
    ...
    models = {
        ...
        'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
