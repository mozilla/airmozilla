...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SuggestedEvent.accepted' to match new field type.
        db.rename_column('main_suggestedevent', 'accepted', 'accepted_id')
        # Changing field 'SuggestedEvent.accepted'
        db.alter_column('main_suggestedevent', 'accepted_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Event'], null=True))
        # Adding index on 'SuggestedEvent', fields ['accepted']
        db.create_index('main_suggestedevent', ['accepted_id'])


    def backwards(self, orm):
        # Removing index on 'SuggestedEvent', fields ['accepted']
        db.delete_index('main_suggestedevent', ['accepted_id'])


        # Renaming column for 'SuggestedEvent.accepted' to match new field type.
        db.rename_column('main_suggestedevent', 'accepted_id', 'accepted')
        # Changing field 'SuggestedEvent.accepted'
        db.alter_column('main_suggestedevent', 'accepted', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
