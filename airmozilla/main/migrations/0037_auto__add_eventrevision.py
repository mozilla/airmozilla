...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventRevision'
        db.create_table(u'main_eventrevision', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 22, 0, 0))),
        ))
        db.send_create_signal(u'main', ['EventRevision'])

        # Adding M2M table for field channels on 'EventRevision'
        db.create_table(u'main_eventrevision_channels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventrevision', models.ForeignKey(orm[u'main.eventrevision'], null=False)),
            ('channel', models.ForeignKey(orm[u'main.channel'], null=False))
        ))
        db.create_unique(u'main_eventrevision_channels', ['eventrevision_id', 'channel_id'])

        # Adding M2M table for field tags on 'EventRevision'
        db.create_table(u'main_eventrevision_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventrevision', models.ForeignKey(orm[u'main.eventrevision'], null=False)),
            ('tag', models.ForeignKey(orm[u'main.tag'], null=False))
        ))
        db.create_unique(u'main_eventrevision_tags', ['eventrevision_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'EventRevision'
        db.delete_table(u'main_eventrevision')

        # Removing M2M table for field channels on 'EventRevision'
        db.delete_table('main_eventrevision_channels')

        # Removing M2M table for field tags on 'EventRevision'
        db.delete_table('main_eventrevision_tags')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
