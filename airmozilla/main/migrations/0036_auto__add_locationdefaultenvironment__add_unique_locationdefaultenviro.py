...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationDefaultEnvironment'
        db.create_table(u'main_locationdefaultenvironment', (
            ...
            ('template_environment', self.gf('airmozilla.main.fields.EnvironmentField')()),
        ))
        db.send_create_signal(u'main', ['LocationDefaultEnvironment'])

        # Adding unique constraint on 'LocationDefaultEnvironment', fields ['location', 'privacy', 'template']
        db.create_unique(u'main_locationdefaultenvironment', ['location_id', 'privacy', 'template_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LocationDefaultEnvironment', fields ['location', 'privacy', 'template']
        db.delete_unique(u'main_locationdefaultenvironment', ['location_id', 'privacy', 'template_id'])

        # Deleting model 'LocationDefaultEnvironment'
        db.delete_table(u'main_locationdefaultenvironment')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
