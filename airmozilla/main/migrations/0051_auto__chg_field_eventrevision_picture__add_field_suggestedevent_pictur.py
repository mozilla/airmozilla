...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventRevision.picture'
        db.alter_column(u'main_eventrevision', 'picture_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Picture'], null=True))
        # Adding field 'SuggestedEvent.picture'
        db.add_column(u'main_suggestedevent', 'picture',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Picture'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EventRevision.picture'
        db.alter_column(u'main_eventrevision', 'picture_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Picture'], on_delete=models.SET_NULL))
        # Deleting field 'SuggestedEvent.picture'
        db.delete_column(u'main_suggestedevent', 'picture_id')
    ...
    models = {
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 13, 0, 0)'}),
