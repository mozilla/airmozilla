...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAssignment'
        db.create_table(u'main_eventassignment', (
        ...
        db.send_create_signal(u'main', ['EventAssignment'])

        # Adding M2M table for field locations on 'EventAssignment'
        db.create_table(u'main_eventassignment_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventassignment', models.ForeignKey(orm[u'main.eventassignment'], null=False)),
            ('location', models.ForeignKey(orm[u'main.location'], null=False))
        ))
        db.create_unique(u'main_eventassignment_locations', ['eventassignment_id', 'location_id'])

        # Adding M2M table for field users on 'EventAssignment'
        db.create_table(u'main_eventassignment_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventassignment', models.ForeignKey(orm[u'main.eventassignment'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'main_eventassignment_users', ['eventassignment_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'EventAssignment'
        db.delete_table(u'main_eventassignment')

        # Removing M2M table for field locations on 'EventAssignment'
        db.delete_table('main_eventassignment_locations')

        # Removing M2M table for field users on 'EventAssignment'
        db.delete_table('main_eventassignment_users')
    ...
    models = {
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
