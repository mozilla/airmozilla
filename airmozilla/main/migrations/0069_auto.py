...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field topics on 'SuggestedEvent'
        db.create_table(u'main_suggestedevent_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('suggestedevent', models.ForeignKey(orm[u'main.suggestedevent'], null=False)),
            ('topic', models.ForeignKey(orm[u'main.topic'], null=False))
        ))
        db.create_unique(u'main_suggestedevent_topics', ['suggestedevent_id', 'topic_id'])

        # Adding index on 'VidlySubmission', fields ['finished']
        db.create_index(u'main_vidlysubmission', ['finished'])
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)'}),
        ...
        u'main.eventhitstats': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Event']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)'}),
        ...
        u'main.picture': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)'}),
