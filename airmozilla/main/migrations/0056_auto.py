...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field regions on 'Location'
        db.create_table(u'main_location_regions', (
        ...
        db.create_unique(u'main_location_regions', ['location_id', 'region_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field regions on 'Location'
        db.delete_table('main_location_regions')
    ...
    models = {
        ...
        u'main.location': {
            ...
            'regions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['main.Region']", 'null': 'True', 'blank': 'True'}),
