...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.upload'
        db.add_column(u'main_event', 'upload',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_upload', null=True, to=orm['uploads.Upload']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.upload'
        db.delete_column(u'main_event', 'upload_id')
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 10, 0, 0)'}),
        ...
        u'main.eventhitstats': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 10, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 10, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 10, 0, 0)'}),
