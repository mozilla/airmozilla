...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTweet.failed_attempts'
        db.add_column(u'main_eventtweet', 'failed_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTweet.failed_attempts'
        db.delete_column(u'main_eventtweet', 'failed_attempts')
