...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SuggestedEvent.start_time'
        db.alter_column('main_suggestedevent', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SuggestedEvent.start_time'
        raise RuntimeError("Cannot reverse this migration. 'SuggestedEvent.start_time' and its values cannot be restored.")
