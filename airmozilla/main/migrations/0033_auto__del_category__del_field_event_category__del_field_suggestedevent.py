...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'main_event', 'category_id')

        # Deleting field 'SuggestedEvent.category'
        db.delete_column(u'main_suggestedevent', 'category_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'main_event', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Category'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'SuggestedEvent.category'
        db.add_column(u'main_suggestedevent', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Category'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
        ...
        'main.eventhitstats': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
        ...
        'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
        ...
        'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
