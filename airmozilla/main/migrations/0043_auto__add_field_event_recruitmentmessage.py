...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.recruitmentmessage'
        db.add_column(u'main_event', 'recruitmentmessage',
    ...
    def backwards(self, orm):
        # Deleting field 'Event.recruitmentmessage'
        db.delete_column(u'main_event', 'recruitmentmessage_id')
