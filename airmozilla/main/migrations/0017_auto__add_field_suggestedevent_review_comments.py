...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedEvent.review_comments'
        db.add_column('main_suggestedevent', 'review_comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuggestedEvent.review_comments'
        db.delete_column('main_suggestedevent', 'review_comments')
