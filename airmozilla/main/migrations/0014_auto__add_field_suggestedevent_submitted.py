...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedEvent.submitted'
        db.add_column('main_suggestedevent', 'submitted',
    ...
    def backwards(self, orm):
        # Deleting field 'SuggestedEvent.submitted'
        db.delete_column('main_suggestedevent', 'submitted')
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 11, 0, 0)'}),
