...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedEvent.remote_presenters'
        db.add_column('main_suggestedevent', 'remote_presenters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.remote_presenters'
        db.add_column('main_event', 'remote_presenters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuggestedEvent.remote_presenters'
        db.delete_column('main_suggestedevent', 'remote_presenters')

        # Deleting field 'Event.remote_presenters'
        db.delete_column('main_event', 'remote_presenters')
    ...
    models = {
        ...
        'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 0, 0)'}),
        ...
        'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 1, 0, 0)'}),
