...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CuratedGroup'
        db.create_table(u'main_curatedgroup', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 11, 0, 0))),
        ))
        db.send_create_signal(u'main', ['CuratedGroup'])


    def backwards(self, orm):
        # Deleting model 'CuratedGroup'
        db.delete_table(u'main_curatedgroup')
    ...
    models = {
        ...
        u'main.eventhitstats': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 11, 0, 0)'}),
