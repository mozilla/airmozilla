...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.popcorn_url'
        db.add_column(u'main_event', 'popcorn_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SuggestedEvent.popcorn_url'
        db.add_column(u'main_suggestedevent', 'popcorn_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.popcorn_url'
        db.delete_column(u'main_event', 'popcorn_url')

        # Deleting field 'SuggestedEvent.popcorn_url'
        db.delete_column(u'main_suggestedevent', 'popcorn_url')
    ...
    models = {
        ...
        u'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)'}),
        ...
        u'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 6, 0, 0)'}),
