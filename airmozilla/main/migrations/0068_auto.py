...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field topics on 'Event'
        db.create_table(u'main_event_topics', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'main.event'], null=False)),
            ('topic', models.ForeignKey(orm[u'main.topic'], null=False))
        ))
        db.create_unique(u'main_event_topics', ['event_id', 'topic_id'])


    def backwards(self, orm):
        # Removing M2M table for field topics on 'Event'
        db.delete_table('main_event_topics')
