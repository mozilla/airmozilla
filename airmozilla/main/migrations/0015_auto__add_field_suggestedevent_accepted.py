...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SuggestedEvent.accepted'
        db.add_column('main_suggestedevent', 'accepted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SuggestedEvent.accepted'
        db.delete_column('main_suggestedevent', 'accepted')
