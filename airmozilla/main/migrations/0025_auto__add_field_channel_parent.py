...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_channel', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Channel'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channel.parent'
        db.delete_column('main_channel', 'parent_id')
    ...
    models = {
        ...
        'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
        ...
        'main.eventhitstats': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
        ...
        'main.eventtweet': {
            ...
            'send_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
        ...
        'main.vidlysubmission': {
            ...
            'submission_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)'}),
