...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Upload.size'
        db.alter_column(u'uploads_upload', 'size', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Upload.size'
        db.alter_column(u'uploads_upload', 'size', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'main.channel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 23, 0, 0)'}),
