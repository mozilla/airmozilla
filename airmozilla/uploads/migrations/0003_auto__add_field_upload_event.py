...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Upload.event'
        db.add_column(u'uploads_upload', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event', null=True, to=orm['main.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Upload.event'
        db.delete_column(u'uploads_upload', 'event_id')
